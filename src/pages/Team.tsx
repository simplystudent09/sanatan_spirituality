  ...
  return (
    <div className="min-h-screen bg-pageBg pt-20">
      ...
      <section className="py-16 bg-pageBg">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-pageBg rounded-2xl border-2 border-maroon shadow-2xl overflow-hidden">
              <img
                src="/hf_20260216_235849_d195ae28-f9c3-4f60-8ac5-6cfe2a22bc77.png"
              ...
              <div className="p-8">
                ...
                <div className="space-y-4 text-gray-700 text-base sm:text-lg leading-relaxed">
                  <p>
                    Paramhans Yogi Abhinav Ji is the Founder of Sanatan Spirituality Foundation and Co-founder of Sumarti Ashram in Bharat, working alongside Jagadguru Swami Sandeepani ji Maharaj. A dedicated Sanatan Dharma guide and spiritual educator, he leads multiple initiatives for Vedic and Sanatan education across the UK, Bharat, and the USA.
                  </p>
                  <p>
      ...
      {Object.entries(groupedMembers)
        .filter(([level]) => Number(level) !== 1 && Number(level) !== 2)
